                ...
                <div className="w-full max-w-lg mx-auto">
                    <div className="flex items-center space-x-4">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className={`flex items-center justify-center p-4 rounded-full text-white transition-all duration-300 disabled:opacity-50 ${isPro ? 'bg-[rgb(var(--pro-accent))] hover:bg-[rgba(var(--pro-accent),0.8)]' : 'bg-[rgb(var(--base-accent))] hover:bg-[rgba(var(--base-accent),0.8)]'} interactive-glow`}
                        >
