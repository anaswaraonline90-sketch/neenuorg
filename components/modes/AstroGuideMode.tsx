        ...
        <div className="relative flex flex-col h-full w-full p-6 md:p-8 animate-subtle-fade-in-up overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col h-full">
                <div className="flex items-center mb-6 self-center text-center flex-col">
                    <Star className={`w-12 h-12 mb-3 text-[rgb(var(${accentVar}))]`} />
                ...
                <div className="w-full max-w-lg mx-auto">
                    <div className="flex items-center space-x-4">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className={`flex items-center justify-center p-4 rounded-full text-white transition-all duration-300 disabled:opacity-50 bg-[rgb(var(${accentVar}))] hover:bg-[rgba(var(${accentVar}),0.8)] interactive-glow`}
                        >
                ...
                <div className="flex-1 mt-8 flex items-center justify-center">
                    {isLoading && <Loader2 className={`w-16 h-16 text-[rgb(var(${accentVar}))] animate-spin`} />}
                    {prediction && (
