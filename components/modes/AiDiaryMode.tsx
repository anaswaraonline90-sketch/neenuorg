    ...
    const lockedScreen = (
        <div className="flex flex-col items-center justify-center h-full w-full animate-subtle-fade-in-up">
            ...
            <div className="w-full max-w-sm flex items-center space-x-2">
                ...
                />
                <button onClick={handleUnlock} className={`p-3 rounded-full text-white ${isPro ? 'bg-[rgb(var(--pro-accent))] hover:bg-[rgba(var(--pro-accent),0.8)]' : 'bg-[rgb(var(--base-accent))] hover:bg-[rgba(var(--base-accent),0.8)]'} interactive-glow`}>
                    <Unlock />
                </button>
            </div>
    ...
    return (
        <div className="flex flex-col h-full w-full p-6 md:p-8 animate-subtle-fade-in-up">
            <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={handleLock} className={`flex items-center px-4 py-2 rounded-full text-white ${isPro ? 'bg-[rgb(var(--pro-accent))] hover:bg-[rgba(var(--pro-accent),0.8)]' : 'bg-[rgb(var(--base-accent))] hover:bg-[rgba(var(--base-accent),0.8)]'} interactive-glow`}>
            ...
            <div className="flex flex-col md:flex-row gap-8 h-full overflow-hidden">
                <div className="md:w-1/2 flex flex-col">
                    ...
                    />
                    <button onClick={handleSaveEntry} className={`mt-4 w-full flex items-center justify-center py-2 px-4 rounded-lg text-lg font-bold transition-transform duration-200 hover:scale-105 ${isPro ? 'bg-[rgb(var(--pro-accent))]' : 'bg-[rgb(var(--base-accent))]'} interactive-glow`}>
